 ...
 * Versão simplificada sem Radix UI (pode ser adicionado depois)
 */
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'relative w-full max-w-lg rounded-lg border border-gray-700 bg-surface p-6 shadow-lg animate-fade-in',
      className
    )}
    {...props}
  />
